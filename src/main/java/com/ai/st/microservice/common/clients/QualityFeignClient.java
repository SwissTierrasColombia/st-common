...
public interface QualityFeignClient {
    ...
    MicroserviceXTFAttachmentDto findAttachmentById(@PathVariable("deliveryId") Long deliveryId,
            @PathVariable("deliveryProductId") Long deliveryProductId, @PathVariable("attachmentId") Long attachmentId);
    ...
    void udpdateXTFStatusToQualityProcessFinished(@PathVariable("deliveryId") Long deliveryId,
            @PathVariable("deliveryProductId") Long deliveryProductId, @PathVariable("attachmentId") Long attachmentId);

    @PatchMapping("/api/quality/v1/deliveries/{deliveryId}/products/{deliveryProductId}/attachments/{attachmentId}/status/accepted")
    void updateXTFStatusToAccepted(@PathVariable("deliveryId") Long deliveryId,
            @PathVariable("deliveryProductId") Long deliveryProductId, @PathVariable("attachmentId") Long attachmentId);

...
public interface ProviderFeignClient {
    ...
    MicroserviceRequestDto createRequest(@RequestBody MicroserviceCreateRequestDto request) throws BusinessException;

    @GetMapping("/api/providers-supplies/v1/users/{userCode}/providers")
    MicroserviceProviderDto findByUserCode(@PathVariable(name = "userCode") Long userCode);
    ...
    List<MicroserviceRequestDto> getRequestsByProvider(@PathVariable(name = "providerId") Long providerId,
    ...
    List<MicroserviceRequestDto> getRequestsByProviderClosed(@PathVariable(name = "providerId") Long providerId,
            @RequestParam(required = false, name = "user") Long userCode);

    @GetMapping("/api/providers-supplies/v1/requests/{requestId}")
    MicroserviceRequestDto findRequestById(@PathVariable(name = "requestId") Long requestId);

    @GetMapping("/api/providers-supplies/v1/providers/{providerId}/users")
    List<MicroserviceProviderUserDto> findUsersByProviderId(@PathVariable(name = "providerId") Long providerId)
    ...
    MicroserviceRequestDto updateSupplyRequested(@PathVariable(name = "requestId") Long requestId,
    ...
    MicroserviceRequestDto closeRequest(@PathVariable(name = "requestId") Long requestId,
    ...
    MicroserviceTypeSupplyDto findTypeSuppleById(@PathVariable(name = "typeSupplyId") Long typeSupplyId);
    ...
    List<MicroserviceRequestDto> findRequestsByEmmiters(@RequestParam(name = "emmiter_code") Long emmiterCode,
    ...
    List<MicroserviceProviderAdministratorDto> findAdministratorsByProviderId(
            @PathVariable(name = "providerId") Long providerId) throws BusinessException;

    @GetMapping("/api/providers-supplies/v1/administrators/{userCode}/roles")
    List<MicroserviceProviderRoleDto> findRolesByUser(@PathVariable(name = "userCode") Long userCode);

    @GetMapping("/api/providers-supplies/v1/administrators/{userCode}/providers")
    MicroserviceProviderDto findProviderByAdministrator(@PathVariable(name = "userCode") Long userCode);
    ...
    MicroserviceProviderProfileDto createProfile(@PathVariable(name = "providerId") Long providerId,
    ...
    List<MicroserviceProviderProfileDto> getProfilesByProvider(@PathVariable(name = "providerId") Long providerId)
            throws BusinessException;

    @PutMapping(value = "/api/providers-supplies/v1/providers/{providerId}/profiles/{profileId}", consumes = APPLICATION_JSON_VALUE)
    MicroserviceProviderProfileDto updateProfile(@PathVariable(name = "providerId") Long providerId,
    ...
    void deleteProfile(@PathVariable(name = "providerId") Long providerId,
            @PathVariable(name = "profileId") Long profileId) throws BusinessException;

    @PostMapping(value = "/api/providers-supplies/v1/providers/{providerId}/type-supplies", consumes = APPLICATION_JSON_VALUE)
    MicroserviceTypeSupplyDto createTypeSupplies(@PathVariable(name = "providerId") Long providerId,
    ...
    List<MicroserviceTypeSupplyDto> getTypesSuppliesByProvider(@PathVariable(name = "providerId") Long providerId)
            throws BusinessException;
    ...
    MicroserviceTypeSupplyDto updateTypeSupplies(@PathVariable(name = "providerId") Long providerId,
            @PathVariable(name = "typeSupplyId") Long typeSupplyId, @RequestBody MicroserviceCreateTypeSupplyDto data)
            throws BusinessException;
    ...
    void deleteTypeSupply(@PathVariable(name = "providerId") Long providerId,
            @PathVariable(name = "typeSupplyId") Long typeSupplyId) throws BusinessException;

    @GetMapping("/api/providers-supplies/v1/users/{userCode}/profiles")
    List<MicroserviceProviderProfileDto> findProfilesByUser(@PathVariable(name = "userCode") Long userCode);
    ...
    MicroserviceRequestPaginatedDto getRequestsByManagerAndProvider(@RequestParam(name = "manager") Long managerCode,
    ...
    List<MicroserviceRequestDto> getRequestsByManagerAndPackage(@RequestParam(name = "manager") Long managerCode,
    ...
    List<MicroserviceRequestDto> getRequestsByPackage(@RequestParam(name = "package_label") String packageLabel)
            throws BusinessException;
    ...
    List<MicroserviceSupplyRequestedDto> getSuppliesRequestedToReview(
            @PathVariable(name = "providerId") Long providerId, @RequestParam(name = "states") List<Long> states)
            throws BusinessException;

    @GetMapping("/api/providers-supplies/v1/supplies-requested/{supplyRequestedId}")
    MicroserviceSupplyRequestedDto getSupplyRequested(@PathVariable(name = "supplyRequestedId") Long supplyRequestedId);
    ...
    MicroserviceSupplyRevisionDto createSupplyRevision(@PathVariable(name = "supplyRequestedId") Long supplyRequestedId,
    ...
    void deleteSupplyRevision(@PathVariable(name = "supplyRequestedId") Long supplyRequestedId,
    ...
    MicroserviceSupplyRevisionDto updateSupplyRevision(@PathVariable(name = "supplyRequestedId") Long supplyRequestedId,
    ...
    MicroservicePetitionDto createPetition(@PathVariable(name = "providerId") Long providerId,
    ...
    List<MicroservicePetitionDto> getPetitionsForManager(@PathVariable(name = "providerId") Long providerId,
            @PathVariable(name = "managerId") Long managerId);

    @GetMapping("/api/providers-supplies/v1/providers/petitions-manager/{managerId}")
    List<MicroservicePetitionDto> getPetitionsByManager(@PathVariable(name = "managerId") Long managerId);

    @GetMapping("/api/providers-supplies/v1/providers/{providerId}/petitions")
    List<MicroservicePetitionDto> getPetitionsForProvider(@PathVariable(name = "providerId") Long providerId,
    ...
    MicroservicePetitionDto updatePetition(@PathVariable(name = "providerId") Long providerId,
    ...
    MicroserviceTypeSupplyDto enableTypeSupply(@PathVariable(name = "typeSupplyId") Long typeSupplyId)
            throws BusinessException;

    @PutMapping(value = "/api/providers-supplies/v1/types-supplies/{typeSupplyId}/disable", consumes = APPLICATION_JSON_VALUE)
    MicroserviceTypeSupplyDto disableTypeSupply(@PathVariable(name = "typeSupplyId") Long typeSupplyId)
            throws BusinessException;
